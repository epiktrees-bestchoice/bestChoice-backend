...
public class ProductDao {
    ...
    public List<Accommodation> checkProduct(SearchReqDto searchReqDto) {
        String ProductSearchQuery = "SELECT a.*  FROM accommodation a LEFT JOIN accommodation_keyword ak ON a.accommodation_id = ak.accommodation_id" +
        ...
        try{
            ...
            return jdbcTemplate.query(ProductSearchQuery, rowMappers.accommodationRowMapper(), ProductSearchObj);
        }
